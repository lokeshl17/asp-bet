...
<body>
    <form name="KhaiLagai" method="post" action="TC.php">
    <br>
...
<div class="drag_drop">
    ...
    <br><h4 align="left" style="color:#FFF;font-family:Verdana, Geneva, sans-serif;font-size:12px;">1. लोगिन करने के बाद अपना पासवर्ड बदल लें। </h4>
    <br>
...
<br><br>
    ...
    <br>
                  ...
                  <br><div class="block">
                        <div class="content">
                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <label class="container">मैंने सभी नियम व शर्तों को अच्छे से पढ़ लिया है और मुझे सभी नियम व शर्ते मंजूर है।
...
<br>
                    ...
                    <div class="menu" id="menu" align="center">
                        <ul class="nav">
                            <li class="active"><a href="javascript:TermsNConditions();" style="font-size:14px !important;line-height:25px;">NEXT =&gt; MAIN MENU</a></li>
                        </ul>
                    </div>
